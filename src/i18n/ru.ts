...
export const ru = {
  ...
  app: {
    ...
    forgetPayer: 'забыть плательщика',
    printHint:
    ...
    payerHint:
      'Реквизиты плательщика сохраняются в этом браузере и подставляются в новые платёжки.',
  ...
  slip: {
    ...
    accountHint: 'рачун примаоца — 18 цифр',
  ...
  ips: {
    accountDigits: 'счёт получателя должен содержать 18 цифр, сейчас {{count}}',
